              ...
              {cartItems.map(item => (
                <div key={item.id} style={styles.cartItem}>
                  ...
                  <div style={styles.itemInfo}>
                    ...
                    <p style={styles.itemPrice}>EGP {item.price}</p>
                  ...
                  <div style={styles.itemActions}>
                    ...
                    <p style={styles.itemTotal}>EGP {(item.price * item.quantity).toFixed(2)}</p>
                    <button 
              ...
              <div style={styles.summaryCard}>
                ...
                <div style={styles.summaryDetails}>
                  <div style={styles.summaryRow}>
                    ...
                    <span style={styles.summaryValue}>EGP {total.toFixed(2)}</span>
                  </div>
                  <div style={styles.summaryRow}>
                    <span style={styles.summaryLabel}>Shipping</span>
                    <span style={styles.summaryValue}>EGP 50.00</span>
                  </div>
                  <div style={styles.summaryRow}>
                    <span style={styles.summaryLabel}>Tax</span>
                    <span style={styles.summaryValue}>EGP {(total * 0.14).toFixed(2)}</span>
                  </div>
                  ...
                  <div style={{...styles.summaryRow, ...styles.summaryTotal}}>
                    ...
                    <span style={styles.totalValue}>EGP {(total + 50 + total * 0.14).toFixed(2)}</span>
                  </div>
                </div>
                  ...
                  onClick={async () => {
                    ...
                    try {
                      ...
                      if (e.response && e.response.status === 401) {
                        ...
                        const msg = backendMsg?.quantity?.[0] || backendMsg?.detail || backendMsg?.error || JSON.stringify(backendMsg) || e.message;
